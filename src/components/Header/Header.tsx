...
export default function Header() {
  ...
  return (
    <div className=' top-0   w-full bg-[#ff001b] pb-5 pt-2 text-white'>
      <div className='container'>
        <NavHeader />
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          <Link to='/' className='col-span-2 rounded-full'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                {...register('name')}
              />
              <button className='flex-shrink-0 rounded-sm bg-[#ff001b] px-6 py-2 hover:opacity-90'>
                <svg
                  ...
                  {purchasesInCart && purchasesInCart.length > 0 ? (
                    <div className='p-2'>
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        ...
                        <Link
                          to={path.cart}
                          className='rounded-sm bg-[#ff001b] px-4 py-2 capitalize text-white hover:bg-opacity-90'
                        >
                          Xem giỏ hàng
                        </Link>
                      </div>
